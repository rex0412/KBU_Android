...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // === 방향 변경 요청 반영: 초기 이미지 설정 변경 ===
        // 사용자(You)의 이미지를 반전, 컴퓨터(Phone)의 이미지를 원본으로 설정
        imageViewYou.setImageBitmap(flippedBitmaps[0]);   // 반전된 가위 이미지
        imageViewPhone.setImageBitmap(originalBitmaps[2]); // 원본 보 이미지
        // ===============================================
    ...
    private void test(int you) {
        ...
        imageViewYou.setImageBitmap(flippedBitmaps[you]);
        imageViewPhone.setImageBitmap(originalBitmaps[phone]);
